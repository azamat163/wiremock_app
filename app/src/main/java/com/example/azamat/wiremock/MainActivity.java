   ...
   // EditText edit1;
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //  edit1 = (EditText) findViewById(R.id.editText);
        ...
        butstart = (Button) findViewById(R.id.button2);
        butstop = (Button)  findViewById(R.id.button3);
        ...
        but.setOnClickListener(new OnClickListener() {
          ...
          //      text1 = edit1.getText().toString().trim();
          //      if (!text1.isEmpty()) {
          //          editPref.putString("edit1", text1);
          //      }

                text2 = edit2.getText().toString().trim();
                if (!text2.isEmpty()) {
                    editPref.putString("edit2", text2);
                }

                text3 = edit3.getText().toString().trim();
                if (!text3.isEmpty()) {
                    editPref.putString("edit3", text3);
                }

                text4 = edit4.getText().toString().trim();
                if (!text4.isEmpty()) {
...
*/
   ...
   butstart.setOnClickListener(new OnClickListener() {
       @Override
       public void onClick(View v) {
            wm = new WireMockServer(options().port(Integer.parseInt(text2)));
           wm.start();
